...
# Most recent rejected ballots

These ballots were received on `r today`.
```{r}
vote_forecast <- readr::read_csv(here('data/voter_forecast_2025_hiercal.csv'))

obs_returns |>
  filter(ballot_status == 'Rejected', received_date == today) |>
  ...
  downloadthis::download_this(
    ...
    button_label = paste('Download rejected ballots received', today),
    button_type = 'primary',
    has_icon = TRUE,
    icon = 'fa fa-save',
    csv2 = FALSE
